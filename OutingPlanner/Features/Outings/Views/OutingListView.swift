...
#Preview {
    ...
    let container: ModelContainer = {
        ...
        let dest1 = Destination(name: "Blok M Plaza", purpose: "Mall", time: Date(), location: "Lantai 5", notes: "Beli bakmi", budget: 50_000)
        let dest2 = Destination(name: "Kopi Kenangan", purpose: "Food", time: Date().addingTimeInterval(7_200), location: "Lantai UG", notes: "Kopi susu", budget: 25_000)
        outing1.destinations = [dest1, dest2]
